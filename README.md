...
- [ ] Explain what a token is used for.
    ...
    > A token is used for keeping track if a user has successfully signed in with correct credentials or not.

- [ ] What steps can you take in your web apps to keep your data secure?

    > You can use Private Routing to verify that a user has a correct token before allowing them access to certain pages.

- [ ] Describe how web servers work.

    > Web servers hold the data for your website and also run the server for computers to connect to
